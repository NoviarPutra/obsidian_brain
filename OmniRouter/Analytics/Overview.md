...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 21814
success_rate: "97.1%"
last_updated: "2026-09-03T21:30:01.327458+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-03 21:30:01 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `9.2k` | `514.24M` | `2.58M` | `3901 ms` |
| **`groq`** | `7.0k` | `8.4k` | `1.7k` | `1300 ms` |
| **`claude`** | `2.0k` | `24.93M` | `119.1k` | `782 ms` |
| **`ollama-cloud`** | `1.1k` | `0` | `0` | `734 ms` |
| **`openrouter`** | `948` | `2.7k` | `854` | `860 ms` |
| **`upstage`** | `635` | `501` | `24` | `426 ms` |
