...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 28523
success_rate: "97.6%"
last_updated: "2026-09-05T17:30:02.032879+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-05 17:30:02 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `28.5k`
- **Success Rate**: `97.63%`
- **Input Tokens Processed**: `642.48M` (`642,477,121` tokens)
- **Output Tokens Generated**: `3.25M` (`3,250,971` tokens)
- **Cache Tokens Read**: `568.99M`
- **Avg Response Duration**: `2,288 ms`
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `11.1k` | `615.08M` | `3.04M` | `3919 ms` |
| **`groq`** | `10.7k` | `74.1k` | `4.8k` | `1347 ms` |
| **`claude`** | `2.6k` | `27.30M` | `208.2k` | `1021 ms` |
...
| **`gemini-3.7-flash-high`** | `antigravity` | `9.6k` | `592.16M` | `4052 ms` |
