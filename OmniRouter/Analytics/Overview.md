...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 32615
success_rate: "97.9%"
last_updated: "2026-09-06T20:00:01.741351+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-06 20:00:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `32.6k`
- **Success Rate**: `97.91%`
...
| :--- | :--- | :--- | :--- | :--- |
| **`groq`** | `12.9k` | `74.1k` | `4.8k` | `1352 ms` |
| **`antigravity`** | `12.4k` | `707.47M` | `3.37M` | `3861 ms` |
| **`claude`** | `2.9k` | `27.30M` | `208.2k` | `912 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `12.8k` | `0` | `1342 ms` |
