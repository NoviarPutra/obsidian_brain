...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 30065
success_rate: "97.7%"
last_updated: "2026-09-06T03:00:01.703197+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-06 03:00:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `30.1k`
- **Success Rate**: `97.74%`
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `11.6k` | `674.10M` | `3.21M` | `3907 ms` |
| **`groq`** | `11.5k` | `74.1k` | `4.8k` | `1349 ms` |
| **`claude`** | `2.7k` | `27.30M` | `208.2k` | `978 ms` |
| **`upstage`** | `1.3k` | `17.9k` | `144` | `411 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `11.4k` | `0` | `1338 ms` |
| **`gemini-3.7-flash-high`** | `antigravity` | `10.1k` | `651.35M` | `4059 ms` |
| **`connection-test`** | `claude` | `2.5k` | `0` | `6 ms` |
| **`connection-test`** | `upstage` | `1.3k` | `0` | `408 ms` |
| **`connection-test`** | `antigravity` | `1.1k` | `0` | `442 ms` |
