...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 33648
success_rate: "97.8%"
last_updated: "2026-09-07T02:00:02.037113+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-07 02:00:02 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `33.6k`
- **Success Rate**: `97.79%`
- **Input Tokens Processed**: `730.16M` (`730,163,488` tokens)
- **Output Tokens Generated**: `3.59M` (`3,590,906` tokens)
- **Cache Tokens Read**: `645.08M`
- **Avg Response Duration**: `2,211 ms`
...
| :--- | :--- | :--- | :--- | :--- |
| **`groq`** | `13.4k` | `74.1k` | `4.8k` | `1345 ms` |
| **`antigravity`** | `12.4k` | `702.74M` | `3.38M` | `3847 ms` |
...
| **`openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7`** | `180` | `27.2k` | `111` | `2150 ms` |
| **`zenmux`** | `164` | `57` | `128` | `1501 ms` |
| **`agentrouter`** | `52` | `414` | `37` | `5260 ms` |
| **`openai-compatible-chat-f3465424-d157-4419-a80a-f2cdee9559b8`** | `51` | `333` | `81` | `5892 ms` |
| **`aihorde`** | `48` | `0` | `0` | `2544 ms` |
| **`AG`** | `45` | `0` | `0` | `8951 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `13.3k` | `0` | `1336 ms` |
...
| **`connection-test`** | `openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7` | `167` | `0` | `1713 ms` |
| **`openai/gpt-oss-120b`** | `groq` | `67` | `78.6k` | `3065 ms` |
| **`connection-test`** | `aihorde` | `46` | `0` | `2558 ms` |
| **`AG`** | `AG` | `45` | `0` | `8951 ms` |
| **`connection-test`** | `agentrouter` | `45` | `0` | `5934 ms` |
