...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 34499
success_rate: "97.8%"
last_updated: "2026-09-07T05:30:01.601178+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-07 05:30:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `34.5k`
- **Success Rate**: `97.80%`
...
| :--- | :--- | :--- | :--- | :--- |
| **`groq`** | `13.7k` | `74.1k` | `4.8k` | `1339 ms` |
| **`antigravity`** | `12.8k` | `722.30M` | `3.44M` | `3844 ms` |
| **`claude`** | `3.0k` | `27.30M` | `208.2k` | `898 ms` |
...
| **`openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7`** | `303` | `27.2k` | `111` | `1998 ms` |
| **`zenmux`** | `164` | `57` | `128` | `1501 ms` |
| **`agentrouter`** | `93` | `414` | `37` | `5474 ms` |
| **`aihorde`** | `89` | `0` | `0` | `2582 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `13.6k` | `0` | `1330 ms` |
...
| **`connection-test`** | `openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7` | `290` | `0` | `1740 ms` |
| **`claude-sonnet-5`** | `claude` | `246` | `27.51M` | `10765 ms` |
| **`connection-test`** | `aihorde` | `87` | `0` | `2591 ms` |
| **`connection-test`** | `agentrouter` | `86` | `0` | `5844 ms` |
