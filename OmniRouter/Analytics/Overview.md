...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 39378
success_rate: "98.2%"
last_updated: "2026-09-12T12:45:34.951900+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-12 12:45:34 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`groq`** | `13.6k` | `86` | `64` | `1171 ms` |
| **`antigravity`** | `9.5k` | `587.33M` | `2.75M` | `4056 ms` |
| **`openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7`** | `4.7k` | `36.9k` | `160` | `2287 ms` |
...
| **`agentrouter`** | `1.5k` | `414` | `37` | `5338 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `13.6k` | `0` | `1170 ms` |
| **`gemini-3.7-flash-high`** | `antigravity` | `6.3k` | `476.63M` | `4443 ms` |
| **`connection-test`** | `openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7` | `4.7k` | `0` | `2226 ms` |
...
| **`connection-test`** | `aihorde` | `1.5k` | `0` | `2833 ms` |
| **`connection-test`** | `agentrouter` | `1.5k` | `0` | `5358 ms` |
