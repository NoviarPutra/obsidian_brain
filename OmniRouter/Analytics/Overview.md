...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 21872
success_rate: "97.1%"
last_updated: "2026-09-03T22:00:01.641599+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-03 22:00:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `21.9k`
- **Success Rate**: `97.12%`
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `9.2k` | `514.24M` | `2.58M` | `3899 ms` |
| **`groq`** | `7.1k` | `8.4k` | `1.7k` | `1300 ms` |
| **`claude`** | `2.0k` | `24.93M` | `119.1k` | `780 ms` |
| **`ollama-cloud`** | `1.1k` | `0` | `0` | `734 ms` |
| **`openrouter`** | `948` | `2.7k` | `854` | `860 ms` |
| **`upstage`** | `641` | `501` | `24` | `425 ms` |
