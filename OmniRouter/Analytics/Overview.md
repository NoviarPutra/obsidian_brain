...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 30284
success_rate: "97.8%"
last_updated: "2026-09-06T05:00:01.473104+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-06 05:00:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `30.3k`
- **Success Rate**: `97.76%`
- **Input Tokens Processed**: `701.50M` (`701,502,575` tokens)
- **Output Tokens Generated**: `3.42M` (`3,424,932` tokens)
- **Cache Tokens Read**: `621.76M`
- **Avg Response Duration**: `2,264 ms`
...
| :--- | :--- | :--- | :--- | :--- |
| **`groq`** | `11.7k` | `74.1k` | `4.8k` | `1350 ms` |
| **`antigravity`** | `11.6k` | `674.10M` | `3.21M` | `3903 ms` |
| **`claude`** | `2.7k` | `27.30M` | `208.2k` | `970 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `11.6k` | `0` | `1340 ms` |
...
| **`connection-test`** | `antigravity` | `1.1k` | `0` | `441 ms` |
