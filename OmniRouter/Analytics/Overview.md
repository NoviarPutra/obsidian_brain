...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 22095
success_rate: "97.2%"
last_updated: "2026-09-04T00:00:03.058107+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-04 00:00:03 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `22.1k`
- **Success Rate**: `97.15%`
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `9.2k` | `514.24M` | `2.58M` | `3893 ms` |
| **`groq`** | `7.2k` | `8.4k` | `1.7k` | `1306 ms` |
| **`claude`** | `2.1k` | `24.93M` | `119.1k` | `772 ms` |
| **`ollama-cloud`** | `1.1k` | `0` | `0` | `734 ms` |
| **`openrouter`** | `948` | `2.7k` | `854` | `860 ms` |
| **`upstage`** | `664` | `501` | `24` | `422 ms` |
...
| **`connection-test`** | `antigravity` | `705` | `0` | `479 ms` |
| **`connection-test`** | `upstage` | `660` | `0` | `420 ms` |
