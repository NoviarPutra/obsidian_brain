...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 41159
success_rate: "98.2%"
last_updated: "2026-09-13T23:16:52.950454+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-13 23:16:52 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `41.2k`
- **Success Rate**: `98.19%`
- **Input Tokens Processed**: `525.30M` (`525,296,309` tokens)
- **Output Tokens Generated**: `2.70M` (`2,699,644` tokens)
- **Cache Tokens Read**: `325.32M`
- **Avg Response Duration**: `2,357 ms`
...
| **`antigravity`** | `9.3k` | `525.28M` | `2.70M` | `4184 ms` |
...
| **`agentrouter`** | `1.8k` | `0` | `0` | `5177 ms` |
| **`openrouter`** | `230` | `845` | `612` | `1083 ms` |
| **`deepseek`** | `131` | `0` | `0` | `1274 ms` |
| **`openai-compatible-chat-18c5987c-aa01-4e00-97e6-3ccbb9f3e844`** | `85` | `2.1k` | `851` | `3793 ms` |
| **`opencode`** | `68` | `98` | `80` | `718 ms` |
...
| **`connection-test`** | `agentrouter` | `1.8k` | `0` | `5175 ms` |
| **`connection-test`** | `openrouter` | `209` | `0` | `331 ms` |
| **`connection-test`** | `deepseek` | `125` | `0` | `1275 ms` |
| **`connection-test`** | `openai-compatible-chat-18c5987c-aa01-4e00-97e6-3ccbb9f3e844` | `69` | `0` | `393 ms` |
| **`connection-test`** | `opencode` | `65` | `0` | `703 ms` |
