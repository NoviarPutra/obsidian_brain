...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 30400
success_rate: "97.8%"
last_updated: "2026-09-06T06:00:01.372174+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-06 06:00:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `30.4k`
- **Success Rate**: `97.77%`
- **Input Tokens Processed**: `701.50M` (`701,502,575` tokens)
- **Output Tokens Generated**: `3.42M` (`3,424,932` tokens)
- **Cache Tokens Read**: `621.76M`
- **Avg Response Duration**: `2,259 ms`
...
| :--- | :--- | :--- | :--- | :--- |
| **`groq`** | `11.8k` | `74.1k` | `4.8k` | `1351 ms` |
| **`antigravity`** | `11.6k` | `674.10M` | `3.21M` | `3901 ms` |
| **`claude`** | `2.8k` | `27.30M` | `208.2k` | `966 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `11.7k` | `0` | `1341 ms` |
| **`gemini-3.7-flash-high`** | `antigravity` | `10.1k` | `651.35M` | `4059 ms` |
| **`connection-test`** | `claude` | `2.5k` | `0` | `6 ms` |
| **`connection-test`** | `upstage` | `1.3k` | `0` | `406 ms` |
| **`connection-test`** | `antigravity` | `1.1k` | `0` | `440 ms` |
