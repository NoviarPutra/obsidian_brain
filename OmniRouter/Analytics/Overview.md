...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 34426
success_rate: "97.8%"
last_updated: "2026-09-07T05:00:02.168641+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-07 05:00:02 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `34.4k`
- **Success Rate**: `97.80%`
- **Input Tokens Processed**: `749.73M` (`749,729,939` tokens)
- **Output Tokens Generated**: `3.65M` (`3,651,923` tokens)
- **Cache Tokens Read**: `659.97M`
...
| **`antigravity`** | `12.8k` | `722.30M` | `3.44M` | `3845 ms` |
| **`claude`** | `3.0k` | `27.30M` | `208.2k` | `896 ms` |
...
| **`openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7`** | `285` | `27.2k` | `111` | `1972 ms` |
| **`zenmux`** | `164` | `57` | `128` | `1501 ms` |
| **`agentrouter`** | `87` | `414` | `37` | `5586 ms` |
| **`aihorde`** | `83` | `0` | `0` | `2588 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `13.6k` | `0` | `1331 ms` |
| **`gemini-3.7-flash-high`** | `antigravity` | `11.0k` | `698.77M` | `4017 ms` |
| **`connection-test`** | `claude` | `2.7k` | `0` | `6 ms` |
| **`connection-test`** | `upstage` | `1.6k` | `0` | `398 ms` |
...
| **`connection-test`** | `openai-compatible-chat-858b1eaf-e606-4423-8349-9d0e73c391b7` | `272` | `0` | `1695 ms` |
| **`claude-sonnet-5`** | `claude` | `246` | `27.51M` | `10765 ms` |
| **`connection-test`** | `aihorde` | `81` | `0` | `2597 ms` |
| **`connection-test`** | `agentrouter` | `80` | `0` | `5993 ms` |
