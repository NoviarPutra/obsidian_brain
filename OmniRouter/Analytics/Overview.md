...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 27932
success_rate: "97.6%"
last_updated: "2026-09-05T14:00:01.577983+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-05 14:00:01 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `10.9k` | `604.84M` | `2.98M` | `3931 ms` |
| **`groq`** | `10.4k` | `74.1k` | `4.8k` | `1347 ms` |
| **`claude`** | `2.6k` | `27.30M` | `208.2k` | `1037 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `10.3k` | `0` | `1335 ms` |
