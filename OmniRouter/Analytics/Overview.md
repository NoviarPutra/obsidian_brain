...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 27286
success_rate: "97.5%"
last_updated: "2026-09-05T08:30:01.473110+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-05 08:30:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `27.3k`
- **Success Rate**: `97.53%`
- **Input Tokens Processed**: `629.42M` (`629,415,076` tokens)
- **Output Tokens Generated**: `3.19M` (`3,188,035` tokens)
- **Cache Tokens Read**: `558.64M`
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `10.8k` | `602.02M` | `2.97M` | `3940 ms` |
| **`groq`** | `10.0k` | `74.1k` | `4.8k` | `1345 ms` |
| **`claude`** | `2.5k` | `27.30M` | `208.2k` | `1063 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `9.9k` | `0` | `1333 ms` |
| **`gemini-3.7-flash-high`** | `antigravity` | `9.4k` | `579.03M` | `4052 ms` |
| **`connection-test`** | `claude` | `2.3k` | `0` | `6 ms` |
| **`connection-test`** | `upstage` | `1.0k` | `0` | `414 ms` |
| **`connection-test`** | `ollama-cloud` | `1.0k` | `0` | `673 ms` |
| **`connection-test`** | `antigravity` | `961` | `0` | `457 ms` |
