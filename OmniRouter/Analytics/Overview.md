...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 27758
success_rate: "97.6%"
last_updated: "2026-09-05T12:30:02.222632+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-05 12:30:02 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `10.9k` | `604.84M` | `2.98M` | `3935 ms` |
| **`groq`** | `10.3k` | `74.1k` | `4.8k` | `1345 ms` |
| **`claude`** | `2.6k` | `27.30M` | `208.2k` | `1044 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `10.2k` | `0` | `1334 ms` |
...
| **`connection-test`** | `antigravity` | `993` | `0` | `454 ms` |
