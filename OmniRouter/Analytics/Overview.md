...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 27361
success_rate: "97.5%"
last_updated: "2026-09-05T09:00:01.960723+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-05 09:00:01 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `10.8k` | `604.84M` | `2.98M` | `3944 ms` |
| **`groq`** | `10.0k` | `74.1k` | `4.8k` | `1345 ms` |
| **`claude`** | `2.5k` | `27.30M` | `208.2k` | `1061 ms` |
...
| **`connection-test`** | `antigravity` | `965` | `0` | `459 ms` |
