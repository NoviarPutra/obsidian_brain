...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 21756
success_rate: "97.1%"
last_updated: "2026-09-03T21:00:01.941353+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-03 21:00:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `21.8k`
- **Success Rate**: `97.11%`
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `9.2k` | `514.24M` | `2.58M` | `3902 ms` |
| **`groq`** | `7.0k` | `8.4k` | `1.7k` | `1298 ms` |
| **`claude`** | `2.0k` | `24.93M` | `119.1k` | `785 ms` |
| **`ollama-cloud`** | `1.1k` | `0` | `0` | `734 ms` |
| **`openrouter`** | `948` | `2.7k` | `854` | `860 ms` |
| **`upstage`** | `629` | `501` | `24` | `427 ms` |
