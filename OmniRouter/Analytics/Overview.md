...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 22153
success_rate: "97.2%"
last_updated: "2026-09-04T00:30:01.440318+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-04 00:30:01 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `9.2k` | `514.24M` | `2.58M` | `3892 ms` |
| **`groq`** | `7.3k` | `8.4k` | `1.7k` | `1307 ms` |
| **`claude`** | `2.1k` | `24.93M` | `119.1k` | `769 ms` |
| **`ollama-cloud`** | `1.1k` | `0` | `0` | `734 ms` |
| **`openrouter`** | `948` | `2.7k` | `854` | `860 ms` |
| **`upstage`** | `670` | `501` | `24` | `421 ms` |
...
| **`connection-test`** | `antigravity` | `709` | `0` | `478 ms` |
| **`connection-test`** | `upstage` | `666` | `0` | `419 ms` |
