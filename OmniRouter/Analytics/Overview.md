...
success_rate: "97.8%"
last_updated: "2026-09-06T10:30:01.532874+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-06 10:30:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `31.0k`
- **Success Rate**: `97.81%`
- **Input Tokens Processed**: `703.73M` (`703,725,751` tokens)
- **Output Tokens Generated**: `3.44M` (`3,436,309` tokens)
- **Cache Tokens Read**: `623.27M`
...
| **`antigravity`** | `11.8k` | `676.33M` | `3.22M` | `3882 ms` |
| **`claude`** | `2.8k` | `27.30M` | `208.2k` | `948 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `12.0k` | `0` | `1340 ms` |
| **`gemini-3.7-flash-high`** | `antigravity` | `10.2k` | `653.59M` | `4048 ms` |
