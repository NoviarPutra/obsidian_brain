...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 28048
success_rate: "97.6%"
last_updated: "2026-09-05T15:00:01.427859+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-05 15:00:01 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `10.9k` | `604.84M` | `2.98M` | `3928 ms` |
| **`groq`** | `10.5k` | `74.1k` | `4.8k` | `1347 ms` |
| **`claude`** | `2.6k` | `27.30M` | `208.2k` | `1032 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `10.4k` | `0` | `1336 ms` |
...
| **`connection-test`** | `antigravity` | `1.0k` | `0` | `451 ms` |
