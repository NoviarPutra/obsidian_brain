...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 22864
success_rate: "97.1%"
last_updated: "2026-09-04T06:00:02.100228+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-04 06:00:02 UTC*
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `9.3k` | `515.06M` | `2.59M` | `3870 ms` |
| **`groq`** | `7.8k` | `74.1k` | `4.8k` | `1321 ms` |
| **`claude`** | `2.1k` | `24.93M` | `119.1k` | `746 ms` |
| **`ollama-cloud`** | `1.1k` | `0` | `0` | `734 ms` |
| **`openrouter`** | `948` | `2.7k` | `854` | `860 ms` |
| **`upstage`** | `737` | `17.9k` | `144` | `417 ms` |
