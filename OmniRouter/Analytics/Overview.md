...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 27990
success_rate: "97.6%"
last_updated: "2026-09-05T14:30:02.038756+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-05 14:30:02 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `28.0k`
- **Success Rate**: `97.59%`
...
| :--- | :--- | :--- | :--- | :--- |
| **`antigravity`** | `10.9k` | `604.84M` | `2.98M` | `3929 ms` |
| **`groq`** | `10.5k` | `74.1k` | `4.8k` | `1347 ms` |
| **`claude`** | `2.6k` | `27.30M` | `208.2k` | `1034 ms` |
| **`ollama-cloud`** | `1.1k` | `0` | `0` | `734 ms` |
| **`upstage`** | `1.1k` | `17.9k` | `144` | `416 ms` |
...
| :--- | :--- | :--- | :--- | :--- |
| **`connection-test`** | `groq` | `10.4k` | `0` | `1335 ms` |
| **`gemini-3.7-flash-high`** | `antigravity` | `9.4k` | `581.86M` | `4058 ms` |
| **`connection-test`** | `claude` | `2.3k` | `0` | `6 ms` |
| **`connection-test`** | `upstage` | `1.1k` | `0` | `412 ms` |
| **`connection-test`** | `ollama-cloud` | `1.0k` | `0` | `673 ms` |
| **`connection-test`** | `antigravity` | `1.0k` | `0` | `450 ms` |
