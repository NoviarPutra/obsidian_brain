...
tags:
  - omniroute/analytics
  - omniroute/dashboard
total_requests: 30458
success_rate: "97.8%"
last_updated: "2026-09-06T06:30:01.859388+00:00"
---
# 📈 OmniRoute AI Telemetry & Usage Overview

*Synced from OmniRoute VPS database on 2026-09-06 06:30:01 UTC*

## ⚡ Key Metrics

- **Total AI Requests**: `30.5k`
- **Success Rate**: `97.77%`
- **Input Tokens Processed**: `701.50M` (`701,502,575` tokens)
- **Output Tokens Generated**: `3.42M` (`3,424,932` tokens)
- **Cache Tokens Read**: `621.76M`
- **Avg Response Duration**: `2,257 ms`
...
| **`antigravity`** | `11.6k` | `674.10M` | `3.21M` | `3899 ms` |
| **`claude`** | `2.8k` | `27.30M` | `208.2k` | `964 ms` |
